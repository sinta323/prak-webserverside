   ...
   if($namaOk && $emailOk){
    $kursus = $_POST['kursus']; 
        ...
        echo "Terimakasih data anda telah diterima.<br>
               Kursus yang anda pilih sebanyak 2 buah yaitu: ";
        echo "<ul>";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <tr>
        <td>Nama Kursus</td>
    <td>
        <input type="checkbox" name="kursus[]" value="PHP">PHP(biaya Rp.1.000.000)<br>
        <input type="checkbox" name="kursus[]" value="JavaScript">JavaScript(biaya Rp.500.000)<br>
        <input type="checkbox" name="kursus[]" value="Python">Python(biaya Rp.800.000)<br>
        <input type="checkbox" name="kursus[]" value="Java">Java(biaya Rp.1.100.000)<br>
    </td>
    </tr>
    <tr><td>&nbsp;</td>
